...
public sealed class TLb : Token
{
    public TLb(string text)
    {
        Text = text;
    }

    public TLb(string text, int line, int pos)
    {
        Text = text;
        Line = line;
        Pos = pos;
...
public sealed class TRb : Token
{
    public TRb(string text)
    {
        Text = text;
    }

    public TRb(string text, int line, int pos)
    {
        Text = text;
        Line = line;
        Pos = pos;
